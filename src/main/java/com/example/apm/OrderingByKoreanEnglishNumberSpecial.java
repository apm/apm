...
import static com.example.apm.CharUtil.*;
...
public class OrderingByKoreanEnglishNumberSpecial {
    ...
    public static Comparator<String> getComparator() {
        return new Comparator<String>() {
            public int compare(String left, String right) {
                return OrderingByKoreanEnglishNumberSpecial.compare(left, right);
            }
        };
    }
    ...
    public static int compare(String left, String right) {
        ...
        left = left.replaceAll(" ", "").toUpperCase();
        right = right.replaceAll(" ", "").toUpperCase();
